...
import { Plus, Download, Upload, Search, Settings2, FileCog, Tag, FileText, AlertCircle } from "lucide-react";
              ...
              <>
                ...
                <div className="absolute top-full right-0 mt-2 w-80 bg-white/95 dark:bg-gray-800/95 backdrop-blur-lg rounded-lg border border-gray-200 dark:border-gray-700 shadow-xl z-[9999]">
                  ...
                  <div className="px-6 py-3 border-b border-gray-200">
                    ...
                    <p className="text-sm text-gray-600">Category Actions</p>
                  </div>
                  ...
                  <div className="p-3 space-y-2 flex flex-col items-center">
                    ...
                    <button
                      ...
                      className="w-[85%] !pl-8 !pr-4 py-3 text-center text-white bg-blue-600 hover:bg-blue-700 flex items-center justify-center gap-3 transition-colors rounded-lg"
                    >
                      <Upload size={18} />
                      <span>
