...
const NewCategoryDrawer = ({ category, isOpen, onClose }) => {
  ...
  return createPortal(
    <div className="fixed inset-0 bg-black/20 z-[9999] flex justify-end" style={{ top: 0, left: 0, right: 0, bottom: 0 }}>
      <div
          ...
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                {mode === "edit" ? "Edit Category" : "Categories"}
              </h2>
              <p className="text-sm text-gray-600 dark:text-gray-400 mt-1">
                {mode === "edit" ? "Update category information" : "Create a new category"}
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          <div>
            ...
            <div className="relative">
              ...
              <textarea
                ...
                className="w-full pl-12 pr-4 py-3 text-sm border border-gray-300 bg-white text-gray-800 rounded-lg shadow-sm transition duration-150 ease-in-out hover:border-gray-600 focus:outline-none focus:ring-0 focus:border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:placeholder-gray-400 min-h-[120px] resize-none"
                rows={5}
              />
            </div>
            <p className="mt-1 text-xs text-gray-500">
              Optional description to help categorize your items
            </p>
          </div>
