...
type SubmissionResult<T extends FieldValues = FieldValues> = SubmissionSuccess | SubmissionError<T>;
...
declare class SubmissionError<T extends FieldValues = FieldValues> {
    readonly kind = "error";
